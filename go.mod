module github.com/digitalocean/karpenter-provider-digital-ocean
...
replace sigs.k8s.io/karpenter => github.com/gabiflorian/karpenter v0.0.0-20260917070638-f372c8c3bccd
